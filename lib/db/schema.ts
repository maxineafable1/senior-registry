...
export const seniors = sqliteTable('seniors', {
  ...
  psaCertificate: integer('psa_certificate', { mode: 'boolean' }).notNull().default(false),
  pwdId: integer('pwd_id', { mode: 'boolean' }).notNull().default(false),
  seniorId: integer('senior_id', { mode: 'boolean' }).notNull().default(false),
  philhealthId: integer('philhealth_id', { mode: 'boolean' }).notNull().default(false),
